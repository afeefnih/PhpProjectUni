...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($cutAngle >= 0 && $cutAngle < 90) {
        ...
        while ($row2 = mysqli_fetch_assoc($result2)) {
            ...
            while ($damage_row2 = mysqli_fetch_assoc($damage_result2)) {
                $victimId = $damage_row2['coordinate'];
    ...
    foreach ($affectedVictims as $victimId => $cutTrees) {
        ...
        $insert_query = "INSERT INTO Victim (victim, cut_tree) VALUES ('$victimId', '$cutTreeList')";
