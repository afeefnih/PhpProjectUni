...
/*-------------------------------  Volume ---------------------------------------*/
$VolumeMersawaSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 1";
...
$VolumeKeruingSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 2";
...
$VolumeDipMarketSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 3";
...
$VolumeDipNonMarketSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 4";
...
$VolumeNonDipMarketSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 5";
...
$VolumeNonDipNonMarketSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 6";
...
$VolumeOthersSQL = "SELECT SUM(volume) AS totalVolume FROM regime60 WHERE spgroup = 7";
...
/*-------------------------------  Number of tree  ---------------------------------------*/
$CountTreesSpgroup1SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 1";
...
$CountTreesSpgroup2SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 2";
...
$CountTreesSpgroup3SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 3";
...
$CountTreesSpgroup4SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 4";
...
$CountTreesSpgroup5SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 5";
...
$CountTreesSpgroup6SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 6";
...
$CountTreesSpgroup7SQL = "SELECT COUNT(*) AS totalTrees FROM regime60 WHERE spgroup = 7";
...
/*-------------------------------  Production  ---------------------------------------*/
$ProductionTreesSpgroup1SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 1";
...
$ProductionTreesSpgroup2SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 2";
...
$ProductionTreesSpgroup3SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 3";
...
$ProductionTreesSpgroup4SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 4";
...
$ProductionTreesSpgroup5SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 5";
...
$ProductionTreesSpgroup6SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 6";
...
$ProductionTreesSpgroup7SQL = "SELECT SUM(production) AS totalProduction FROM regime60 WHERE spgroup = 7";
...
/*-------------------------------  Damage Crown  ---------------------------------------*/
$DamageCrownSpgroup1SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 1";
...
$DamageCrownSpgroup2SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 2";
...
$DamageCrownSpgroup3SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 3";
...
$DamageCrownSpgroup4SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 4";
...
$DamageCrownSpgroup5SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 5";
...
$DamageCrownSpgroup6SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 6";
...
$DamageCrownSpgroup7SQL = "SELECT SUM(damage_crown) AS totalDamageCrown FROM regime60 WHERE spgroup = 7";
...
/*-------------------------------  Damage stem  ---------------------------------------*/
$DamageStemSpgroup1SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 1";
...
$DamageStemSpgroup2SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 2";
...
$DamageStemSpgroup3SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 3";
...
$DamageStemSpgroup4SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 4";
...
$DamageStemSpgroup5SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 5";
...
$DamageStemSpgroup6SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 6";
...
$DamageStemSpgroup7SQL = "SELECT SUM(damage_stem) AS totalDamageStem FROM regime60 WHERE spgroup = 7";
...
/*-------------------------------  Growth30 ---------------------------------------*/
$Growth30Spgroup1SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 1";
...
$Growth30Spgroup2SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 2";
...
$Growth30Spgroup3SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 3";
...
$Growth30Spgroup4SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 4";
...
$Growth30Spgroup5SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 5";
...
$Growth30Spgroup6SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 6";
...
$Growth30Spgroup7SQL = "SELECT SUM(Growth30) AS totalGrowth30 FROM regime60 WHERE spgroup = 7";
...
/*-------------------------------  Production30  ---------------------------------------*/
$Production30Spgroup1SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 1";
...
$Production30Spgroup2SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 2";
...
$Production30Spgroup3SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 3";
...
$Production30Spgroup4SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 4";
...
$Production30Spgroup5SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 5";
...
$Production30Spgroup6SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 6";
...
$Production30Spgroup7SQL = "SELECT SUM(Production30) AS totalProduction30 FROM regime60 WHERE spgroup = 7";
