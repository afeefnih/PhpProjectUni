...
<head>
    ...
    /*-------------------- Categories 5 - 15 --------------------*/
    $VolumeMersawaSQL = "SELECT COUNT(*) AS totaltress, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 1 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    $VolumeKeruingSQL = "SELECT COUNT(*) AS totaltress, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 2 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    $VolumeDipMarketSQL = "SELECT COUNT(*) AS totaltress,SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 3 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    $VolumeDipNonMarketSQL = "SELECT COUNT(*) AS totaltress ,SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 4 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    $VolumeNonDipMarketSQL = "SELECT COUNT(*) AS totaltress ,SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 5 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    $VolumeNonDipNonMarketSQL = "SELECT COUNT(*) AS totaltress ,SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 6 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    $VolumeOthersSQL = "SELECT COUNT(*) AS totaltress ,SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 7 AND Diameter>=5 AND Diameter<=15 AND blockX = 1 AND blockY = 1";
    ...
    function calculateProductionVolume($dbc, $group) {
        $query = "SELECT SUM(volume) AS totalVolume FROM regime65 
    ...
    function calculatTotalDamage515($dbc, $group) {
        $query = "SELECT SUM(damage_crown) AS totalDamageCrown, SUM(damage_stem) AS totalDamageStem FROM regime65 
                    WHERE spgroup = $group 
                    AND DiameterClass = 1
                    AND blockX = 1 AND blockY = 1";
        $result = mysqli_query($dbc, $query);
    ...
    function calculateGrowth30Volume515($dbc, $group) {
        $query = "SELECT SUM(Growth30) AS totalVolume FROM regime65 
                  WHERE spgroup = $group 
    ...
    function calculateProduction30Volume530($dbc, $group) {
        $query = "SELECT SUM(Production30) AS totalVolume FROM regime65 
                  WHERE spgroup = $group 
                  AND Diameter30 <= 5 AND Diameter30 >= 15 
                  AND blockX = 1 AND blockY = 1";
        $result = mysqli_query($dbc, $query);
    ...
    $CountTreesSpgroup1SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 1 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    $CountTreesSpgroup2SQL = "SELECT COUNT(*) AS totalTrees,SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 2 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    $CountTreesSpgroup3SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 3 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    $CountTreesSpgroup4SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 4 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    $CountTreesSpgroup5SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 5 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    $CountTreesSpgroup6SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 6 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    $CountTreesSpgroup7SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 7 AND Diameter>=15 AND Diameter<=30 AND blockX = 1 AND blockY = 1";
    ...
    /*-------------------- Categories 30 - 45 --------------------*/
    $ProductionTreesSpgroup1SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 1  AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    $ProductionTreesSpgroup2SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 2 AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    $ProductionTreesSpgroup3SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 3 AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    $ProductionTreesSpgroup4SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 4 AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    $ProductionTreesSpgroup5SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 5 AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    $ProductionTreesSpgroup6SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 6 AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    $ProductionTreesSpgroup7SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 7 AND Diameter>=30 AND Diameter<=45 AND blockX = 1 AND blockY = 1";
    ...
    /*-------------------- Categories 45 - 60 --------------------*/
    $DamageCrownSpgroup1SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 1 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
    ...
    $DamageCrownSpgroup2SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 2 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
    ...
    $DamageCrownSpgroup3SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 3 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
    ...
    $DamageCrownSpgroup4SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 4 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
    ...
    $DamageCrownSpgroup5SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 5 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
    ...
    $DamageCrownSpgroup6SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 6 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
    ...
    $DamageCrownSpgroup7SQL = "SELECT COUNT(*) AS totalTrees, SUM(volume) AS totalVolume FROM regime65 WHERE spgroup = 7 AND Diameter>=45 AND Diameter<=60 AND blockX = 1 AND blockY = 1";
